...
Deno.test({
  ...
  only: false,
  fn: () => {
    const tree = ZipSequence.from(frozen);
...
Deno.test({
  ...
  fn: () => {
    ...
    const tree = ZipSequence.from(entries);
...
Deno.test({
  ...
  fn: () => {
    ...
    assert(ZipSequence.empty().remove(0).isEmpty());
  },
});
...
Deno.test({
  ...
  fn: () => {
    ...
    const reduced = ZipSequence.from(pairs.slice(100));
...
Deno.test({
  ...
  fn: () => {
    ...
    assertEquals(firstEmpty, ZipSequence.empty());
    const firstNull = ZipSequence.empty().first(5);
    assertEquals(firstNull, ZipSequence.empty());
...
Deno.test({
  ...
  fn: () => {
    ...
    const singleFirst = ZipSequence.singleton({ key: "A", rank: 0 }).first(2);
    assertEquals(singleFirst.length(), 1);
    const singleLast = ZipSequence.singleton({ key: "A", rank: 0 }).last(2);
...
Deno.test({
  ...
  fn: () => {
    ...
    const [emptyLeft, emptyRight] = ZipSequence.empty().split(12);
    assertEquals(emptyLeft, ZipSequence.empty());
    assertEquals(emptyRight, ZipSequence.empty());
  },
});
...
Deno.test({
  ...
  fn: () => {
    ...
    let leftSide = ZipSequence.empty(), rightSide = ZipSequence.empty();
...
Deno.test({
  ...
  fn: () => {
    ...
    assertEquals(
      ZipSequence.empty().insert(1, { key: 0, rank: 0 }),
      ZipSequence.empty(),
    );
  },
});
...
Deno.test({
  ...
  only: false,
  fn: () => {
    let pushed = ZipSequence.empty();
    let inserted = ZipSequence.empty();
...
Deno.test({
  ...
  fn: () => {
    ...
    assertEquals(ZipSequence.empty().at(0), undefined);
    assertEquals(ZipSequence.empty().remove(0), ZipSequence.empty());
  },
});
